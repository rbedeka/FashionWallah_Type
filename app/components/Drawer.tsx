...
export function Drawer({
  ...
  const handleOpenFromChange = () => {
    setAnimationDirection(openFrom === 'bottom' || openFrom === 'top' ? 'y' : 'x');
  };
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            >
              ...
              >
                ...
                <Dialog.Panel
                  className={`${openFrom === 'bottom' || openFrom === 'top' ?'w-full':'w-fit'} text-left align-middle transition-all transform shadow-xl
